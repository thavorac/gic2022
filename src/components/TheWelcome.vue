<template>
  <WelcomeItem @counted="recieveCount" :incomingMessage="message">
    <template #icon>
      <DocumentationIcon />
    </template>
  ...
  <WelcomeItem :incomingMessage="message">
    <template #icon>
      <ToolingIcon />
    </template>
  ...
  <WelcomeItem incomingMessage="somthing else">
    <template #icon>
      <EcosystemIcon />
    </template>
...
import { useCount } from "../stores/myStore";
